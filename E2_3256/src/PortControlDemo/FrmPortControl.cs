    ...
    public partial class FrmPortControl : Form
    {
        ...
        private void ComReceiveData(string data)
        {
            this.Invoke(new EventHandler(delegate
            {
                ...
                tb_receive.AppendText("[Recv "+ timenow + "]"+$" {data}\n");
            }));
        }
        #endregion

        private void Pe_show_Paint(object sender, PaintEventArgs e)
        {

        }

        private void Pe_set_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void Pe_receive_Paint(object sender, PaintEventArgs e)
        {
